...
def send_message(send_id, msg_txt):
    ...
    print("message text (msg_txt) is: ", msg_txt)

    data = json.dumps({"recipient": {"id": send_id}, "sender_action": "typing_on"})
    r = requests.post("https://graph.facebook.com/v2.6/me/messages", params=params, headers=headers, data=data)

    #mess = "Message is " + msg_txt
    #data = json.dumps({"recipient": {"id": send_id}, "message": {"text": mess}})
    #r = requests.post("https://graph.facebook.com/v2.6/me/messages", params=params, headers=headers, data=data)

    msg_txt = generateResponse(msg_txt)
    data = json.dumps({"recipient": {"id": send_id}, "message": {"text": msg_txt}})
    r = requests.post("https://graph.facebook.com/v2.6/me/messages", params=params, headers=headers, data=data)
